...
class TestJob(unittest.TestCase):
    def test_is_qualified(self):
        ...
        is_qualified_university = test_job.is_qualified(event.Education.UNIVERSITY)
...
test_investment = event.Investment("fake-investmenr-1", "fake-descr-1", -100, event.Type_Investment.LAND)
...
test_special_event = event.Special_Event("fake-se-1", "fake-descr-1", 100, -100, {"relationship_status": [2, 3]})
